...
const organicList = [
  ...
  },
  {
    ...
    description: "Gomutra collection organic flooring",
  },
  {
    id: 3,
    img: require("../../assets/images/organic3.jpeg"),
    description: "Animal shed",
  },
];
  ...
  return (
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        is an environmental friendly method of fodder and livestock production
        without use of synthetic fertilizers growth hormones , antibiotics ,
        chemical drugs , synthetic pesticides. The principle of organic forming
        is{" "}
        <Text style={{ color: "#2d2121", fontSize: 14, fontWeight: "700" }}>
          "sustainable , ecologically sound and viable , socially justified and
          humane"
        </Text>{" "}
        production system
      </Text>
